...
uKer[sp_,m_,J_,k_,q_] := Assuming[J \[Element] Integers && J >= 0 && m >= 0 && sp >= 0,
  Simplify @ SeriesCoefficient[Ker[2m^2-sp-t,t,s1[m],s2[m],k,q]*MABAB[sp,t,m]-Ker[t,2m^2-sp-t,s1[m],s2[m],k,q]*MBBAA[2m^2-sp-t,t,m], {t, 2m^2/3, -1}]
];
...
Print["X[4,2] = ", Xkq[kn,qn,J,sp,m]//Simplify];



Print["massless-limit X[4,2] = ", FullSimplify[Xkq[kn,qn,J,sp,0],Assumptions->{sp>0}]];
