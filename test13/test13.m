...
x10fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = (32 mA^4 + 2 (-1 + J) (8 + J) mA^2 s - (-2 + J (7 + J)) s^2) /
    (2 s^2 (-4 mA^2 + s)^2);
  N[result, 600]
];
...
x20fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = (-1280 mA^6 + 960 mA^4 s +
      2 (-120 + (-1 + J) J (7 + J) (8 + J)) mA^2 s^2 -
      (-20 + J (7 + J) (-13 + J (7 + J))) s^3) /
    (20 s^3 (-4 mA^2 + s)^3);
  N[result, 600]
];
...
x30fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = (92160 mA^8 - 92160 mA^6 s + 34560 mA^4 s^2 +
      2 (-2880 + (-2 + J) (-1 + J) J (7 + J) (8 + J) (9 + J)) mA^2 s^3 -
      (-12 + J (7 + J)) (30 + J (7 + J) (-23 + J (7 + J))) s^4) /
    (360 s^4 (-4 mA^2 + s)^4);
  N[result, 600]
];
...
x40fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(10080 s^5 (-4 mA^2 + s)^5) *
    (-10321920 mA^10 + 12902400 mA^8 s - 6451200 mA^6 s^2 +
      1612800 mA^4 s^3 +
      2 (-100800 + (-3 + J) (-2 + J) (-1 + J) J (7 + J) (8 + J) (9 + J) (10 + J)) mA^2 s^4 +
      (10080 - (-2 + J) J (7 + J) (9 + J) (604 + J (7 + J) (-52 + J (7 + J)))) s^5);
  N[result, 600]
];
...
x41fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = (J (7 + J) (11520 mA^8 - 11520 mA^6 s -
       4 (-936 + J (7 + J) (-26 + J (7 + J))) mA^4 s^2 +
       2 (-216 + J (7 + J) (-26 + J (7 + J))) mA^2 s^3 -
       9 (-23 + J (7 + J)) s^4)) / (180 s^4 (-4 mA^2 + s)^5);
  N[result, 600]
];
...
x50fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(403200 s^6 (-4 mA^2 + s)^6) *
    (1651507200 mA^12 - 2477260800 mA^10 s + 1548288000 mA^8 s^2 -
      516096000 mA^6 s^3 + 96768000 mA^4 s^4 +
      2 (-4838400 + (-4 + J) (-3 + J) (-2 + J) (-1 + J) J (7 + J) (8 + J) (9 + J) (10 + J) (11 + J)) mA^2 s^5 -
      (-403200 + (-4 + J) (-2 + J) J (7 + J) (9 + J) (11 + J) (-34 + J (5 + J)) (-20 + J (9 + J))) s^6);
  N[result, 600]
];
...
x51fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(2520 s^5 (-4 mA^2 + s)^6) * J (7 + J) *
    (-645120 mA^10 + 806400 mA^8 s - 403200 mA^6 s^2 -
      2 (-54720 + J (7 + J) (924 + J (7 + J) (-56 + J (7 + J)))) mA^4 s^3 +
      (-16920 + J (7 + J) (924 + J (7 + J) (-56 + J (7 + J)))) mA^2 s^4 -
      7 (540 + J (7 + J) (-53 + J (7 + J))) s^5);
  N[result, 600]
];
...
x60fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(21772800 s^7 (-4 mA^2 + s)^7) *
    (-356725555200 mA^14 + 624269721600 mA^12 s - 468202291200 mA^10 s^2 +
      195084288000 mA^8 s^3 - 48771072000 mA^6 s^4 + 7315660800 mA^4 s^5 +
      2 (-304819200 + (-5 + J) (-4 + J) (-3 + J) (-2 + J) (-1 + J) J (7 + J) (8 + J) (9 + J) (10 + J) (11 + J) (12 + J)) mA^2 s^6 -
      (-21772800 + (-4 + J) (-2 + J) J (7 + J) (9 + J) (11 + J) (-62 + J (7 + J)) (-48 + J (7 + J)) (-15 + J (7 + J))) s^7);
  N[result, 600]
];
...
x61fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(100800 s^6 (-4 mA^2 + s)^7) * J (7 + J) *
    (103219200 mA^12 - 154828800 mA^10 s + 96768000 mA^8 s^2 - 32256000 mA^6 s^3 -
      2 (-2833920 + J (7 + J) (-44976 + J (7 + J) (3388 + J (7 + J) (-100 + J (7 + J))))) mA^4 s^4 +
      (1 + J) (6 + J) (-69120 + J (7 + J) (4024 + J (7 + J) (-106 + J (7 + J)))) mA^2 s^5 -
      10 (-31032 + J (7 + J) (3024 + (-7 + J) J (7 + J) (14 + J))) s^6);
  N[result, 600]
];
...
x70fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(1524096000 s^8 (-4 mA^2 + s)^8) *
    (99883155456000 mA^16 - 199766310912000 mA^14 s + 174795522048000 mA^12 s^2 -
      87397761024000 mA^10 s^3 + 27311800320000 mA^8 s^4 - 5462360064000 mA^6 s^5 +
      682795008000 mA^4 s^6 +
      2 (-24385536000 + (-6 + J) (-5 + J) (-4 + J) (-3 + J) (-2 + J) (-1 + J) J (7 + J) (8 + J) (9 + J) (10 + J) (11 + J) (12 + J) (13 + J)) mA^2 s^7 -
      (-1524096000 + (-6 + J) (-4 + J) (-2 + J) J (7 + J) (9 + J) (11 + J) (13 + J) (-50 + J (7 + J)) (960 + J (7 + J) (-83 + J (7 + J)))) s^8);
  N[result, 600]
];
...
x71fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(10886400 s^7 (-4 mA^2 + s)^8) * J (7 + J) *
    (-44590694400 mA^14 + 78033715200 mA^12 s - 58525286400 mA^10 s^2 +
      24385536000 mA^8 s^3 - 6096384000 mA^6 s^4 -
      4 (-240019200 + J (7 + J) (2888640 + J (7 + J) (-248256 + J (7 + J) (9388 + J (7 + J) (-160 + J (7 + J)))))) mA^4 s^5 +
      2 (-49507200 + J (7 + J) (2888640 + J (7 + J) (-248256 + J (7 + J) (9388 + J (7 + J) (-160 + J (7 + J)))))) mA^2 s^6 -
      27 (1578240 + J (7 + J) (-209056 + J (7 + J) (8988 + J (7 + J) (-160 + J (7 + J))))) s^7);
  N[result, 600]
];
...
x73fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = -1/(2520 s^5 (-4 mA^2 + s)^8) * (-2 + J) J (7 + J) (9 + J) *
    (3584 (-1 + J) (8 + J) mA^10 + 32 (-10 + J) (-1 + J) (8 + J) (17 + J) mA^8 s -
      32 (-1 + J) (8 + J) (-100 + J (7 + J)) mA^6 s^2 +
      4 (-1 + J) (8 + J) (-230 + 3 J (7 + J)) mA^4 s^3 -
      2 (-1 + J) (8 + J) (-65 + J (7 + J)) mA^2 s^4 +
      7 (-53 + J (7 + J)) s^5);
  N[result, 600]
];
...
x80fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(134120448000 s^9 (-4 mA^2 + s)^9) *
    (-35158870720512000 mA^18 + 79107459121152000 mA^16 s - 79107459121152000 mA^14 s^2 +
      46146017820672000 mA^12 s^3 - 17304756682752000 mA^10 s^4 +
      4326189170688000 mA^8 s^5 - 721031528448000 mA^6 s^6 +
      77253378048000 mA^4 s^7 +
      2 (-2414168064000 + (-7 + J) (-6 + J) (-5 + J) (-4 + J) (-3 + J) (-2 + J) (-1 + J) J (7 + J) (8 + J) (9 + J) (10 + J) (11 + J) (12 + J) (13 + J) (14 + J)) mA^2 s^8 -
      (-134120448000 + (-6 + J) (-4 + J) (-2 + J) J (7 + J) (9 + J) (11 + J) (13 + J) (5001600 + J (7 + J) (-600160 + J (7 + J) (19516 + J (7 + J) (-240 + J (7 + J)))))) s^9);
  N[result, 600]
];
...
x81fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(762048000 s^8 (-4 mA^2 + s)^9) * J (7 + J) *
    (12485394432000 mA^16 - 24970788864000 mA^14 s + 21849440256000 mA^12 s^2 -
      10924720128000 mA^10 s^3 + 3413975040000 mA^8 s^4 - 682795008000 mA^6 s^5 -
      4 (-20447769600 + J (7 + J) (-236718720 + J (7 + J) (22252608 + J (7 + J) (-980520 + J (7 + J) (21868 + J (7 + J) (-238 + J (7 + J))))))) mA^4 s^6 +
      2 (-2158617600 + J (7 + J) (-236718720 + J (7 + J) (22252608 + J (7 + J) (-980520 + J (7 + J) (21868 + J (7 + J) (-238 + J (7 + J))))))) mA^2 s^7 -
      35 (-131466240 + J (7 + J) (17720496 + J (7 + J) (-915804 + J (7 + J) (21808 + J (7 + J) (-241 + J (7 + J)))))) s^8);
  N[result, 600]
];
...
x83fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(50400 s^6 (-4 mA^2 + s)^9) * (-2 + J) J (7 + J) (9 + J) *
    (286720 (-1 + J) (8 + J) mA^12 - 430080 (-1 + J) (8 + J) mA^10 s -
      16 (-1 + J) (8 + J) (-15480 + J (7 + J) (-74 + J (7 + J))) mA^8 s^2 +
      16 (-1 + J) (8 + J) (-4280 + J (7 + J) (-74 + J (7 + J))) mA^6 s^3 -
      6 (-1 + J) (8 + J) (-1480 + J (7 + J) (-74 + J (7 + J))) mA^4 s^4 +
      (-1 + J) (8 + J) (-360 + J (7 + J) (-74 + J (7 + J))) mA^2 s^5 -
      10 (2564 + J (7 + J) (-108 + J (7 + J))) s^6);
  N[result, 600]
];
...
x90fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(14485008384000 s^10 (-4 mA^2 + s)^10) *
    (15188632151261184000 mA^20 - 37971580378152960000 mA^18 s +
      42718027925422080000 mA^16 s^2 - 28478685283614720000 mA^14 s^3 +
      12459424811581440000 mA^12 s^4 - 3737827443474432000 mA^10 s^5 +
      778714050723840000 mA^8 s^6 - 111244864389120000 mA^6 s^7 +
      10429206036480000 mA^4 s^8 +
      2 (-289700167680000 + (-8 + J) (-7 + J) (-6 + J) (-5 + J) (-4 + J) (-3 + J) (-2 + J) (-1 + J) J (7 + J) (8 + J) (9 + J) (10 + J) (11 + J) (12 + J) (13 + J) (14 + J) (15 + J)) mA^2 s^9 -
      (-14485008384000 + (-8 + J) (-6 + J) (-4 + J) (-2 + J) J (7 + J) (9 + J) (11 + J) (13 + J) (15 + J) (5277600 + J (7 + J) (-651672 + J (7 + J) (20980 + J (7 + J) (-250 + J (7 + J)))))) s^10);
  N[result, 600]
];
...
x91fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(33530112000 s^9 (-4 mA^2 + s)^10) * J (7 + J) *
    (-2197429420032000 mA^18 + 4944216195072000 mA^16 s - 4944216195072000 mA^14 s^2 +
      2884126113792000 mA^12 s^3 - 1081547292672000 mA^10 s^4 +
      270386823168000 mA^8 s^5 - 45064470528000 mA^6 s^6 -
      2 (-2501346355200 + J (7 + J) (24088008960 + J (7 + J) (-2417474304 + J (7 + J) (118343568 + J (7 + J) (-3123584 + J (7 + J) (45192 + J (7 + J) (-336 + J (7 + J)))))))) mA^4 s^7 +
      (-388949299200 + J (7 + J) (24088008960 + J (7 + J) (-2417474304 + J (7 + J) (118343568 + J (7 + J) (-3123584 + J (7 + J) (45192 + J (7 + J) (-336 + J (7 + J)))))))) mA^2 s^8 -
      22 (11405836800 + J (7 + J) (-1826254080 + J (7 + J) (107801568 + J (7 + J) (-3100260 + J (7 + J) (46228 + J (7 + J) (-343 + J (7 + J))))))) s^9);
  N[result, 600]
];
...
x93fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(5443200 s^7 (-4 mA^2 + s)^10) * (-2 + J) J (7 + J) (9 + J) *
    (-123863040 (-1 + J) (8 + J) mA^14 + 216760320 (-1 + J) (8 + J) mA^12 s -
      162570240 (-1 + J) (8 + J) mA^10 s^2 -
      32 (-1 + J) (8 + J) (-2196000 + J (7 + J) (5760 + J (7 + J) (-134 + J (7 + J)))) mA^8 s^3 +
      32 (-1 + J) (8 + J) (-608400 + J (7 + J) (5760 + J (7 + J) (-134 + J (7 + J)))) mA^6 s^4 -
      12 (-1 + J) (8 + J) (-290880 + J (7 + J) (5760 + J (7 + J) (-134 + J (7 + J)))) mA^4 s^5 +
      2 (-1 + J) (8 + J) (-185040 + J (7 + J) (5760 + J (7 + J) (-134 + J (7 + J)))) mA^2 s^6 -
      27 (-216000 + J (7 + J) (10752 + J (7 + J) (-182 + J (7 + J)))) s^7);
  N[result, 600]
];
...
x100fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(1883051089920000 s^11 (-4 mA^2 + s)^11) *
    (-7898088718655815680000 mA^22 + 21719743976303493120000 mA^20 s -
      27149679970379366400000 mA^18 s^2 + 20362259977784524800000 mA^16 s^3 -
      10181129988892262400000 mA^14 s^4 + 3563395496112291840000 mA^12 s^5 -
      890848874028072960000 mA^10 s^6 + 159080156076441600000 mA^8 s^7 -
      19885019509555200000 mA^6 s^8 + 1657084959129600000 mA^4 s^9 +
      2 (-41427123978240000 + (-9 + J) (-8 + J) (-7 + J) (-6 + J) (-5 + J) (-4 + J) (-3 + J) (-2 + J) (-1 + J) J (7 + J) (8 + J) (9 + J) (10 + J) (11 + J) (12 + J) (13 + J) (14 + J) (15 + J) (16 + J)) mA^2 s^10 +
      (1883051089920000 - (-8 + J) (-6 + J) (-4 + J) (-2 + J) J (7 + J) (9 + J) (11 + J) (13 + J) (15 + J) (-797572800 + J (7 + J) (106776000 + J (7 + J) (-3946556 + J (7 + J) (60108 + J (7 + J) (-405 + J (7 + J))))))) s^11);
  N[result, 600]
];
...
x101fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(3621252096000 s^10 (-4 mA^2 + s)^11) * J (7 + J) *
    (949289509453824000 mA^20 - 2373223773634560000 mA^18 s +
      2669876745338880000 mA^16 s^2 - 1779917830225920000 mA^14 s^3 +
      778714050723840000 mA^12 s^4 - 233614215217152000 mA^10 s^5 +
      48669628170240000 mA^8 s^6 - 6952804024320000 mA^6 s^7 -
      2 (-315451293696000 + J (7 + J) (-2977739366400 + J (7 + J) (314184925440 + J (7 + J) (-16618702464 + J (7 + J) (493173648 + J (7 + J) (-8546624 + J (7 + J) (85512 + J (7 + J) (-456 + J (7 + J))))))))) mA^4 s^8 +
      (-25751126016000 + J (7 + J) (-2977739366400 + J (7 + J) (314184925440 + J (7 + J) (-16618702464 + J (7 + J) (493173648 + J (7 + J) (-8546624 + J (7 + J) (85512 + J (7 + J) (-456 + J (7 + J))))))))) mA^2 s^9 -
      27 (-1379752704000 + J (7 + J) (225934848000 + J (7 + J) (-14770082880 + J (7 + J) (486509168 + J (7 + J) (-8812960 + J (7 + J) (88928 + J (7 + J) (-468 + J (7 + J)))))))) s^10);
  N[result, 600]
];
...
x103fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(381024000 s^8 (-4 mA^2 + s)^11) * (-2 + J) J (7 + J) (9 + J) *
    (34681651200 (-1 + J) (8 + J) mA^16 - 69363302400 (-1 + J) (8 + J) mA^14 s +
      60692889600 (-1 + J) (8 + J) mA^12 s^2 - 30346444800 (-1 + J) (8 + J) mA^10 s^3 -
      32 (-1 + J) (8 + J) (-290174400 + J (7 + J) (-528480 + J (7 + J) (16212 + J (7 + J) (-212 + J (7 + J))))) mA^8 s^4 +
      32 (-1 + J) (8 + J) (-53092800 + J (7 + J) (-528480 + J (7 + J) (16212 + J (7 + J) (-212 + J (7 + J))))) mA^6 s^5 -
      12 (-1 + J) (8 + J) (-13579200 + J (7 + J) (-528480 + J (7 + J) (16212 + J (7 + J) (-212 + J (7 + J))))) mA^4 s^6 +
      2 (-1 + J) (8 + J) (-2289600 + J (7 + J) (-528480 + J (7 + J) (16212 + J (7 + J) (-212 + J (7 + J))))) mA^2 s^7 -
      35 (21948480 + J (7 + J) (-1323000 + J (7 + J) (28702 + J (7 + J) (-277 + J (7 + J))))) s^8);
  N[result, 600]
];
...
x104fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(21772800 s^7 (-4 mA^2 + s)^11) * (-2 + J) J (7 + J) (9 + J) *
    (-17694720 (-3 + J) (-1 + J) (8 + J) (10 + J) mA^14 +
      30965760 (-3 + J) (-1 + J) (8 + J) (10 + J) mA^12 s +
      512 (-3 + J) (-1 + J) (8 + J) (10 + J) (-42720 + J (7 + J) (-104 + J (7 + J))) mA^10 s^2 -
      640 (-3 + J) (-1 + J) (8 + J) (10 + J) (-12480 + J (7 + J) (-104 + J (7 + J))) mA^8 s^3 +
      320 (-3 + J) (-1 + J) (8 + J) (10 + J) (-4920 + J (7 + J) (-104 + J (7 + J))) mA^6 s^4 -
      80 (-3 + J) (-1 + J) (8 + J) (10 + J) (-1896 + J (7 + J) (-104 + J (7 + J))) mA^4 s^5 +
      10 (-3 + J) (-1 + J) (8 + J) (10 + J) (-48 + (-1 + J) J) (8 + J (15 + J)) mA^2 s^6 -
      (35064000 + J (7 + J) (-1763640 + J (7 + J) (31942 + J (7 + J) (-277 + J (7 + J))))) s^7);
  N[result, 600]
];
...
x110fst[x_?NumericQ] := Module[{s, mA, J, result},
  ...
  mA = N[mAval, 600];
  J = J1;
  result = 1/(-4 mA^2 + s)^12 -
    1/(289989867847680000 (-4 mA^2 + s)^12) * (-10 + J) (-8 + J) (-6 + J) (-4 + J) (-2 + J) J (7 + J) (9 + J) (11 + J) (13 + J) (15 + J) (17 + J) *
      (-833676480 + J (7 + J) (114378912 + J (7 + J) (-4230052 + J (7 + J) (63448 + J (7 + J) (-417 + J (7 + J)))))) +
    (16777216 mA^24)/(s^12 (-4 mA^2 + s)^12) - (50331648 mA^22)/(s^11 (-4 mA^2 + s)^12) +
    (69206016 mA^20)/(s^10 (-4 mA^2 + s)^12) - (57671680 mA^18)/(s^9 (-4 mA^2 + s)^12) +
    (32440320 mA^16)/(s^8 (-4 mA^2 + s)^12) - (12976128 mA^14)/(s^7 (-4 mA^2 + s)^12) +
    (3784704 mA^12)/(s^6 (-4 mA^2 + s)^12) - (811008 mA^10)/(s^5 (-4 mA^2 + s)^12) +
    (126720 mA^8)/(s^4 (-4 mA^2 + s)^12) - (14080 mA^6)/(s^3 (-4 mA^2 + s)^12) +
    (1056 mA^4)/(s^2 (-4 mA^2 + s)^12) +
    1/(144994933923840000 s (-4 mA^2 + s)^12) *
      (-6959756828344320000 + (-10 + J) (-9 + J) (-8 + J) (-7 + J) (-6 + J) (-5 + J) (-4 + J) (-3 + J) (-2 + J) (-1 + J) J (7 + J) (8 + J) (9 + J) (10 + J) (11 + J) (12 + J) (13 + J) (14 + J) (15 + J) (16 + J) (17 + J)) mA^2;
  N[result, 600]
];
