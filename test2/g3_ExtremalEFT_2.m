...
n4[x_?NumericQ, J_?IntegerQ] := (1/(1 - x)^11)*2*J*(J+1)*(J*(J+1)-8)*(1-x)^5;

fList = {f1, f2, n4, X52, X62, X72, X82, X92, X102};   (* one entry per component of y; must match Length[norm] *)
...
extraTriplet = {0, 0, 0, 0, 0, 0, 0, 0, -1/812851200};

norm = {0, 1, 0, 0, 0, 0, 0, 0, 0};    (* normalisation: y2 = 1                *)
obj  = {-1, 0, 0, 0, 0, 0, 0, 0, 0};   (* objective: maximise -y1 = minimise y1 *)
